...
class ChatItemDelegate : public QStyledItemDelegate {
    ...
    private slots:
        void onAvatarLoaded(const QString& userId, const QPixmap& pixmap);
    ...
    private:
        ...
        void drawBubble(QPainter* painter, const QRect& rect, bool isFromMe, const ChatMessage* message, bool isSelected) const;

        void drawTextMessage(QPainter* painter, const QRect& rect, const QString& text, bool isFromMe, bool isSelected) const;

        void drawImageMessage(QPainter* painter, const QRect& rect, const QPixmap& image, bool isFromMe) const;

        void drawAvatar(QPainter* painter, const QRect& rect, const QString& userID) const;

        void drawGroupInfo(QPainter* painter, const QRect& rect, const ChatMessage* message) const;

        void drawGroupInfoForMe(QPainter* painter, const QRect& rect, const ChatMessage* message) const;

        void drawTimeHeader(QPainter* painter, const QRect& rect, const QString& text) const;

        QRect calculateBubbleRect(const QRect& contentRect, const ChatMessage* message, int maxWidth, bool isFromMe) const;
