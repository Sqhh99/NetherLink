...
#include "View/Friend/SearchResultItem.h"
...
void SearchResultItem::setupUI() {
    ...
    actionButton->setFont(QFont("", 12));

    // 连接按钮点击事件
    connect(actionButton, &CustomPushButton::clicked, this, &SearchResultItem::onActionButtonClicked);
}
