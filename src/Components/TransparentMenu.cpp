    ...
    for (QAction* action : actions()) {
        ...
        if (action->isSeparator()) {
            ...
            if (hasIcon) {
                ...
                QRect iconRect(itemRect.left() + 12, itemRect.top() + (itemRect.height() - iconSize.height()) / 2, iconSize.width(), iconSize.height());
            ...
            painter.drawText(textRect, Qt::AlignVCenter | Qt::AlignLeft | Qt::TextSingleLine, action->text());
        }
    }
}
